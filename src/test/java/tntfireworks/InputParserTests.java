...
public class InputParserTests extends TestCase {
    ...
    public void testTwoLocationsCsv() {
        String source = "LOC #, ADDRESS #, NAME,ADDRESS,CITY,ST,ZIP,COUNTY,MKT PRG,LEGAL C,DISC,RBU,BP,CO,SA #,SA NAME,CUST #, NAME,SEASON,YEAR,MACHINE TYPE\n"
    ...
    public void testBadMarketingPlanHeaderCSV() {
        String source = "BAD"
                + "Item Number,CAT,Category,Item Description,Case Packing,Unit Price,Pricing UOM,Suggested Selling Price,Selling UOM,UPC,Net Item,Expired Date,Eff Date Date,Buy 1Get N Free Value,3rd Item Number,Cur Cod\n100073,10,ASSORTMENTS ,BIG BOMB TRAY C               ,1-Apr,59.99,EA,59.99,EA,027736004485,N,12/31/2040,5/1/2015,,AS104                    ,USD\n100382,10,ASSORTMENTS ,TNT HOT SHOT BAG C            ,24/1                          ,14.99,EA,14.99,EA,027736000098,N,12/31/2040,8/1/2012,,AS123                    ,USD";
        String expectedDeleteQuery = "DELETE FROM tntfireworks_marketing_plans WHERE mktPlan='6RET'";
    ...
    public void testBadFilename() {
        ...
        InputParser inputParser = new InputParser(dbConnection, 5);
        Assert.assertEquals(InputParser.LOCATIONS_FILENAME,
                inputParser.getMarketPlan("20161223154529_locations_12222016.csv"));
