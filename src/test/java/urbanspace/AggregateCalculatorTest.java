...
public class AggregateCalculatorTest {
    ...
    @Test
    public void generate_PullDataFromStagingAccountWithManyDifferentKindsOfData_ExpectReportsToMatch()
            throws Exception {
        ReportGeneratorPayload reportGeneratorPayload = new ReportGeneratorPayload();
        SquareClient squareClient = new SquareClient("na-RKUREpIDcP4JZhfgrNQ", "https://connect.squareupstaging.com",
                "v1", "CH5CPYTZN2CR5", "CH5CPYTZN2CR5");
        ...
        sp.setMerchantAlias("Ben");
        sp.setMerchantId("CH5CPYTZN2CR5");

        reportGeneratorPayload.setSquarePayload(sp);
        ...
        reportGeneratorPayload
                .setRefundPayments(squareRefundPayments.toArray(new Payment[squareRefundPayments.size()]));
