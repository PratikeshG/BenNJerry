...
public class AggregateReportGenerator {
    ...
    public String generate(List<ReportGeneratorPayload> reportGeneratorPayloads) throws ParseException {
        ...
        for (ReportGeneratorPayload reportGeneratorPayload : reportGeneratorPayloads) {
            ...
            locationResult
                    .setGiftCardSalesRefunds(reportCalculator.totalMoneyCollectedForGiftCardsRefunds(refundPayments));
            locationResult
                    .setGiftCardSalesNet(locationResult.getGiftCardSales() + locationResult.getGiftCardSalesRefunds());
            ...
            locationResult
                    .setTotalTaxMoneyNet(locationResult.getTotalTaxMoney() + locationResult.getTotalTaxMoneyRefunds());
            ...
            locationResult
                    .setTotalTipMoneyNet(locationResult.getTotalTipMoney() + locationResult.getTotalTipMoneyRefunds());
            ...
            locationResult
                    .setTotalCollectedMoneyRefunds(reportCalculator.totalTotalCollectedMoneyRefunds(refundPayments));
            locationResult.setTotalCollectedMoneyNet(
                    locationResult.getTotalCollectedMoney() + locationResult.getTotalCollectedMoneyRefunds());
            ...
            locationResult.setTotalDiscountsMoneyNet(
                    locationResult.getTotalDiscountsMoney() + locationResult.getTotalDiscountsMoneyRefunds());
            ...
            locationResult.setNetSalesRefunds(
                    locationResult.getGrossSalesRefunds() + locationResult.getTotalDiscountsMoneyRefunds());
            ...
            locationResult.setTotalCashMoneyRefunds(
                    reportCalculator.totalMoneyCollectedForTenderRefunds(refundPayments, "CASH"));
            locationResult.setTotalCashMoneyNet(
                    locationResult.getTotalCashMoney() + locationResult.getTotalCashMoneyRefunds());

            locationResult.setTotalCardMoney(reportCalculator.totalMoneyCollectedForTender(payments, "CREDIT_CARD"));
            locationResult.setTotalCardMoneyRefunds(
                    reportCalculator.totalMoneyCollectedForTenderRefunds(refundPayments, "CREDIT_CARD"));
            locationResult.setTotalCardMoneyNet(
                    locationResult.getTotalCardMoney() + locationResult.getTotalCardMoneyRefunds());

            locationResult
                    .setTotalGiftCardMoney(reportCalculator.totalMoneyCollectedForTender(payments, "SQUARE_GIFT_CARD"));
            locationResult.setTotalGiftCardMoneyRefunds(
                    reportCalculator.totalMoneyCollectedForTenderRefunds(refundPayments, "SQUARE_GIFT_CARD"));
            locationResult.setTotalGiftCardMoneyNet(
                    locationResult.getTotalGiftCardMoney() + locationResult.getTotalGiftCardMoneyRefunds());

            locationResult.setTotalOtherMoney(reportCalculator.totalMoneyCollectedForTender(payments, "NO_SALE")
                    + reportCalculator.totalMoneyCollectedForTender(payments, "SQUARE_WALLET")
                    + reportCalculator.totalMoneyCollectedForTender(payments, "UNKNOWN")
                    + reportCalculator.totalMoneyCollectedForTender(payments, "OTHER")
                    + reportCalculator.totalMoneyCollectedForTender(payments, "THIRD_PARTY_CARD"));
            locationResult.setTotalOtherMoneyRefunds(
                    reportCalculator.totalMoneyCollectedForTenderRefunds(refundPayments, "NO_SALE")
                            + reportCalculator.totalMoneyCollectedForTenderRefunds(refundPayments, "SQUARE_WALLET")
                            + reportCalculator.totalMoneyCollectedForTenderRefunds(refundPayments, "UNKNOWN")
                            + reportCalculator.totalMoneyCollectedForTenderRefunds(refundPayments, "OTHER")
                            + reportCalculator.totalMoneyCollectedForTenderRefunds(payments, "THIRD_PARTY_CARD"));
            locationResult.setTotalOtherMoneyNet(
                    locationResult.getTotalOtherMoney() + locationResult.getTotalOtherMoneyRefunds());

            locationResult.setTotalPartialRefundsMoney(0);
            locationResult
                    .setTotalPartialRefundsMoneyRefunds(reportCalculator.totalPartialRefundsRefunds(refundPayments));
            locationResult.setTotalPartialRefundsMoneyNet(
                    locationResult.getTotalPartialRefundsMoney() + locationResult.getTotalPartialRefundsMoneyRefunds());
            ...
            locationResult.setTotalFeesMoneyNet(
                    locationResult.getTotalFeesMoney() + locationResult.getTotalFeesMoneyRefunds());

            locationResult
                    .setNetTotalMoney(locationResult.getTotalCollectedMoney() + locationResult.getTotalFeesMoney());
            locationResult.setNetTotalMoneyRefunds(
                    locationResult.getTotalCollectedMoneyRefunds() + locationResult.getTotalFeesMoneyRefunds());
            locationResult
                    .setNetTotalMoneyNet(locationResult.getNetTotalMoney() + locationResult.getNetTotalMoneyRefunds());
