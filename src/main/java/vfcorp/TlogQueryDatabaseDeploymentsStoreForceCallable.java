...
public class TlogQueryDatabaseDeploymentsStoreForceCallable implements Callable {
    ...
    public Object onCall(MuleEventContext eventContext) throws Exception {
        ...
        String whereFilter = String.format("deploymentGroup LIKE '%s' AND enableTLOG = 1", deploymentGroup);
