...
public class ItemRecord extends Record {
	...
	static {
		...
		fields.put("Return Indicator", new FieldDetails(1, 445, "zero filled, 1 = Can be returned, 0 = Cannot be returned"));
		fields.put("Fractional Quantity Indicator", new FieldDetails(1, 446, "zero filled, 1 = True, 0 = False (default)"));
	}
