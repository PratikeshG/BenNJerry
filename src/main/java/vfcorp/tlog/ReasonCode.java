...
public class ReasonCode extends Record {
    ...
    public static final String REASON_CODE_PRICE_CORRECT = "111";
    ...
    public ReasonCode parse(String reasonCode, String functionIndicator) throws Exception {
        putValue("Reason Code", reasonCode);
        putValue("Function Indicator", functionIndicator);
        putValue("Special Indicator", "0");
