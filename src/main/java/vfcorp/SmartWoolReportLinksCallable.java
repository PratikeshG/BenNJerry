...
public class SmartWoolReportLinksCallable implements Callable {
    ...
    public Object onCall(MuleEventContext eventContext) throws Exception {
        ...
        emailBody.append(
                "Please see the links below to download the prior day's transaction, item, and deposit reports.<br/>");
