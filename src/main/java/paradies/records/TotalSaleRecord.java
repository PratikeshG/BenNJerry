...
public class TotalSaleRecord extends Record {
	...
	public TotalSaleRecord() {
		...
		Field[] createFields = {
			...
			new Field(15, FIELD_POSITIVE_FLAG, 57, "1", Field.Type.ALPHANUMERIC),
			new Field(16, FIELD_TAX_1, 58, "4.2", Field.Type.NUMERIC),
			new Field(17, FIELD_POSITIVE_FLAG, 64, "1", Field.Type.ALPHANUMERIC),
			...
			new Field(21, FIELD_POSITIVE_FLAG, 77, "1", Field.Type.ALPHANUMERIC),
			...
			new Field(29, FIELD_POSITIVE_FLAG, 103, "1", Field.Type.ALPHANUMERIC),
			...
			new Field(34, FIELD_POSITIVE_FLAG, 119, "1", Field.Type.ALPHANUMERIC),
			new Field(35, FIELD_TOTAL_SAVED, 120, "6.2", Field.Type.NUMERIC),
			new Field(36, FIELD_POSITIVE_FLAG, 128, "1", Field.Type.ALPHANUMERIC)
		};
