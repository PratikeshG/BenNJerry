 ...
 */
public class EncryptedMethodOfPaymentRecord extends Record {
	...
	public EncryptedMethodOfPaymentRecord() {
		...
		Field[] createFields = {
			...
			new Field(24, FIELD_DECLINE_OVERRIDE, 179, "1", Field.Type.NUMERIC),
			new Field(25, FIELD_PROFILE_PROMPT_FLAG, 179, "1", Field.Type.NUMERIC),
			new Field(26, FIELD_CURRENCY_CODE, 180, "3", Field.Type.ALPHANUMERIC)
		};
