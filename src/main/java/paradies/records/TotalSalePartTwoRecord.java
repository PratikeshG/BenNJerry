...
public class TotalSalePartTwoRecord extends Record {
	...
	public TotalSalePartTwoRecord() {
		...
		Field[] createFields = {
			...
			new Field(15, FIELD_POSITIVE_FLAG, 55, "1", Field.Type.ALPHANUMERIC),
			new Field(16, FIELD_TAX_6, 56, "4.2", Field.Type.NUMERIC),
			new Field(17, FIELD_POSITIVE_FLAG, 62, "1", Field.Type.ALPHANUMERIC),
			new Field(18, FIELD_TAX_7, 63, "4.2", Field.Type.NUMERIC),
			new Field(19, FIELD_POSITIVE_FLAG, 69, "1", Field.Type.ALPHANUMERIC),
			new Field(20, FIELD_TAX_8, 70, "4.2", Field.Type.NUMERIC),
			new Field(21, FIELD_POSITIVE_FLAG, 76, "1", Field.Type.ALPHANUMERIC),
			new Field(22, FIELD_TAX_9, 77, "4.2", Field.Type.NUMERIC),
			new Field(23, FIELD_POSITIVE_FLAG, 83, "1", Field.Type.ALPHANUMERIC),
			new Field(24, FIELD_TAX_10, 84, "4.2", Field.Type.NUMERIC),
			new Field(25, FIELD_POSITIVE_FLAG, 90, "1", Field.Type.ALPHANUMERIC),
			new Field(26, FIELD_TAX_11, 91, "4.2", Field.Type.NUMERIC),
			new Field(27, FIELD_POSITIVE_FLAG, 97, "1", Field.Type.ALPHANUMERIC),
			new Field(28, FIELD_TAX_12, 98, "4.2", Field.Type.NUMERIC),
			new Field(29, FIELD_POSITIVE_FLAG, 104, "1", Field.Type.ALPHANUMERIC),
			new Field(30, FIELD_TAX_13, 105, "4.2", Field.Type.NUMERIC),
			new Field(31, FIELD_POSITIVE_FLAG, 111, "1", Field.Type.ALPHANUMERIC),
			new Field(32, FIELD_TAX_14, 112, "4.2", Field.Type.NUMERIC),
			new Field(33, FIELD_POSITIVE_FLAG, 118, "1", Field.Type.ALPHANUMERIC),
			new Field(34, FIELD_TAX_15, 119, "4.2", Field.Type.NUMERIC),
			new Field(35, FIELD_POSITIVE_FLAG, 125, "1", Field.Type.ALPHANUMERIC),
			new Field(36, FIELD_TAX_16, 126, "4.2", Field.Type.NUMERIC),
			new Field(37, FIELD_POSITIVE_FLAG, 132, "1", Field.Type.ALPHANUMERIC),
		};
