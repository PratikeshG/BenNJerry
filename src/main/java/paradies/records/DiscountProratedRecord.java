...
public class DiscountProratedRecord extends Record {
	...
	public static final String FIELD_POSITIVE_FLAG_DISCOUNT = "Positive Flag Discount";
	...
	public static final String FIELD_POSITIVE_FLAG_ORIGINAL_PRICE = "Positive Flag Original Price";
	...
	public DiscountProratedRecord() {
		...
		Field[] createFields = {
			...
			new Field(18, FIELD_POSITIVE_FLAG_DISCOUNT, 66, "1", Field.Type.ALPHANUMERIC),
			...
			new Field(21, FIELD_POSITIVE_FLAG_ORIGINAL_PRICE, 95, "1", Field.Type.ALPHANUMERIC),
